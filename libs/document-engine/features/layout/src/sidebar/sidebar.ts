    ...
    return [
      ...
      // { id: 'assets', name: 'Assets', url: ROUTE.ASSETS, icon: 'diamond', type: 'normal' },
      {
        ...
        items: [
          ...
          { id: 'editor-image-ref', name: 'Image Ref', url: `${ROUTE.EDITOR}/image-ref`, type: 'normal' },
      ...
      },
      {
        ...
        items: [
          {
            id: 'template-document-builder',
            name: 'Document Builder',
            url: `${ROUTE.TEMPLATE}/document-builder`,
            type: 'normal',
          },
          {
            id: 'template-a',
            name: 'Template A',
            url: `${ROUTE.TEMPLATE}/template-a`,
            type: 'normal',
          },
          {
            id: 'template-b',
            name: 'Template B',
            url: `${ROUTE.TEMPLATE}/template-b`,
            type: 'normal',
          },
        ],
      },
